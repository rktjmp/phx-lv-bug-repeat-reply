defmodule RepeatReplyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RepeatReplyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RepeatReplyWeb.Gettext, "errors", msg, opts)
    end
  end
